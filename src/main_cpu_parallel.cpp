...
int main(int argc, char** argv) {
    ...
    tbb::parallel_for((size_t)0, numAlignments, [=](size_t n){ // Parallelize outer for loop - seq[0:15], seq[16:31], ... are processed in parallel
    ...
    fprintf(stdout, "Completed parallel for in %ld msec \n\n", timer.Stop());
